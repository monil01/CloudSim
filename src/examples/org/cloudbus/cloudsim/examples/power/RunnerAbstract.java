...
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyMaximumCorrelation_sla;
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyMaximumCorrelationWithMigrationControl;
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyMaximumCorrelationWithMigrationControlsd;
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyMinimumMigrationTime;
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyMinimumMigrationTimeWithMigrationControl;
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyMinimumMigrationTimeWithMigrationControlsd;
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyMinimumUtilization;
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyMinimumUtilizationWithMigrationControl;
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyRandomSelection;
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyRandomSelectionWithMigrationControl;
import org.cloudbus.cloudsim.power.PowerVmSelectionPolicyRandomSelectionWithMigrationControlsd;
import org.cloudbus.cloudsim.power.PowerFuzzyVmSelectionPolicy;
import org.cloudbus.cloudsim.power.PowerFuzzyVmSelectionPolicy11;
/**
...
public abstract class RunnerAbstract {
	...
	protected static List<PowerHost> hostList;
        protected boolean monil; // by monil
	/**
	 * Run.
	 * 
	...
	protected VmAllocationPolicy getVmAllocationPolicy(
		...
		if (vmAllocationPolicyName.equals("iqr")) {
			...
			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationLocalRegressionRobust(
					...
					Constants.SCHEDULING_INTERVAL,
					fallbackVmSelectionPolicy);
		} else if (vmAllocationPolicyName.equals("msm")) {
			PowerVmAllocationPolicyMigrationAbstract fallbackVmSelectionPolicy = new PowerVmAllocationPolicyMigrationStaticThreshold(
					hostList,
					vmSelectionPolicy,
					0.7);
			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationModifiedStddeviationMean(
					hostList,
					vmSelectionPolicy,
					parameter,
					fallbackVmSelectionPolicy);
		} else if (vmAllocationPolicyName.equals("msmd")) {
			PowerVmAllocationPolicyMigrationAbstract fallbackVmSelectionPolicy = new PowerVmAllocationPolicyMigrationStaticThreshold(
					hostList,
					vmSelectionPolicy,
					0.7);
			vmAllocationPolicy = new PowerVmAllocationPolicyMigrationModifiedStddeviationMedian(
					hostList,
					vmSelectionPolicy,
					parameter,
					fallbackVmSelectionPolicy);
	...
	protected PowerVmSelectionPolicy getVmSelectionPolicy(String vmSelectionPolicyName) {
		...
		} else if (vmSelectionPolicyName.equals("mcmc")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyMaximumCorrelationWithMigrationControl(
					new PowerVmSelectionPolicyMinimumMigrationTime());
                                        //new PowerVmSelectionPolicyMinimumMigrationTimeWithMigrationControl());
		} else if (vmSelectionPolicyName.equals("mcsla")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyMaximumCorrelation_sla(
					new PowerVmSelectionPolicyMinimumMigrationTime());
                                        //new PowerVmSelectionPolicyMinimumMigrationTimeWithMigrationControl());                                        
		} else if (vmSelectionPolicyName.equals("mcmcs")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyMaximumCorrelationWithMigrationControlsd(
					new PowerVmSelectionPolicyMinimumMigrationTime());
                                        //new PowerVmSelectionPolicyMinimumMigrationTimeWithMigrationControl());
                } else if (vmSelectionPolicyName.equals("fs")) {
			vmSelectionPolicy = new PowerFuzzyVmSelectionPolicy11(
					new PowerVmSelectionPolicyMinimumMigrationTime());
                                        //new PowerVmSelectionPolicyMinimumMigrationTimeWithMigrationControl());
                } else if (vmSelectionPolicyName.equals("mmt")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyMinimumMigrationTime();
		} else if (vmSelectionPolicyName.equals("mmtmc")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyMinimumMigrationTimeWithMigrationControl();
		} else if (vmSelectionPolicyName.equals("mmtmcs")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyMinimumMigrationTimeWithMigrationControlsd();
                } else if (vmSelectionPolicyName.equals("mu")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyMinimumUtilization();
                } else if (vmSelectionPolicyName.equals("mumc")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyMinimumUtilizationWithMigrationControl();
                } else if (vmSelectionPolicyName.equals("rs")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyRandomSelection();
                } else if (vmSelectionPolicyName.equals("rsmc")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyRandomSelectionWithMigrationControl();
                } else if (vmSelectionPolicyName.equals("rsmcs")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyRandomSelectionWithMigrationControlsd();
                } else if (vmSelectionPolicyName.equals("migmc")) {
			vmSelectionPolicy = new PowerVmSelectionPolicyMaximumCorrelationWithMigrationControl( //by monil
                                        new PowerVmSelectionPolicyMinimumMigrationTime());
		} else {
