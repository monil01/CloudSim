...
public class IqrMcRandom {
	...
	public static void main(String[] args) throws IOException {
		...
		String vmSelectionPolicy = "mcsla"; // Maximum Correlation (MC) VM selection policy
		String parameter = "1.5"; // the safety parameter of the IQR policy
                //RandomConstants.NUMBER_OF_HOSTS=200;
                //for ( RandomConstants.NUMBER_OF_VMS=400; RandomConstants.NUMBER_OF_VMS<401; RandomConstants.NUMBER_OF_VMS += 50)
                for ( double i=0; i<15; i+=.5)
                {
                    parameter = Double.toString(i);
		new RandomRunner(
				enableOutput,
				outputToFile,
				inputFolder,
