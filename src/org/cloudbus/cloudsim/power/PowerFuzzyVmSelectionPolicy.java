 ...
 */
public class PowerFuzzyVmSelectionPolicy extends PowerVmSelectionPolicy {
...
/*    
	 ...
	 */
	public PowerFuzzyVmSelectionPolicy(final PowerVmSelectionPolicy fallbackPolicy) {
		super();
	...
	public Vm getVmToMigrate(final PowerHost host) {
            	String filename = "fuzzyvmselection3.fcl";
		FIS fis = FIS.load(filename, true);
		...
		for (int i = 0; i < metrics.size(); i++) {
                        ...
                        } else */ metric5=(float)((metric0+metric1+metric2+metric3+metric4)/5);
