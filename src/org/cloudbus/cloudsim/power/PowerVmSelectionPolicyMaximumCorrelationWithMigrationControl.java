 ...
 */
public class PowerVmSelectionPolicyMaximumCorrelationWithMigrationControl extends PowerVmSelectionPolicy {
	 ...
	 */
	public PowerVmSelectionPolicyMaximumCorrelationWithMigrationControl(final PowerVmSelectionPolicy fallbackPolicy) {
		super();
