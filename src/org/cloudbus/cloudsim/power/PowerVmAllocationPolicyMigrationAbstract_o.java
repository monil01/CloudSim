 ...
 */
public abstract class PowerVmAllocationPolicyMigrationAbstract_o extends PowerVmAllocationPolicyAbstract {
	...
	private final List<Double> executionTimeHistoryTotal = new LinkedList<Double>();
        public int numberofunderload=0;
	/**
	...
	public PowerVmAllocationPolicyMigrationAbstract_o(
